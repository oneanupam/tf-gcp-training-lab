...
- Once you add the moved block and run `terraform plan`, plan will show that old_resource_address has moved to new_resource_address. The move operation completes, when you run `terraform apply`.
